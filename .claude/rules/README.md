...
- [18 — Rango de fechas](18-rango-fechas.md): fecha inicio + fecha fin → `mat-date-range-input` (nunca dos inputs `type="date"`); hoy siempre seleccionable como mínimo/máximo; ajustar CSS local si no calza con la plantilla.
