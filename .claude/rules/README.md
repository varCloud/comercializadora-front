...
- [20 — Tabs](20-tabs.md): `mat-tab-group`/`mat-button-toggle-group` (selector de modo) con estilo delgado + subrayado, **centralizado en `style.scss`**; prohibido reimplementarlo por componente.
- [21 — Paridad visual 1:1 con el legado](21-paridad-visual-legado.md): **regla dura** — la pantalla migrada se ve y se organiza igual que la del legado (secciones, títulos, botones/colores/posición, columnas, modales **como modales**), implementada con componentes de Angular Material; toda diferencia deliberada se documenta.
