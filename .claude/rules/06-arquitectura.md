...
- El feature de producto **`admin`** debe usar **componentes standalone** cargados con
  `loadComponent` desde su `*-routing.module.ts`.

## Al crear una pantalla nueva en admin
...
- **No** crees NgModules nuevos dentro de admin.
...
- Lógica/UI reutilizable → `admin/shared/` (ver regla 00), no dentro de una página.
